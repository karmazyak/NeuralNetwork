...
//  NeuralNetwork
//
//  Created by  IvanGorbunov on 18/02/2019.
...
namespace mnist {
    ...
    Container<Image> read_training_images(const std::string& folder, std::size_t limit, Functor func) {
        ...
        read_mnist_image_file<Container, Image>(images,"train-images.idx3-ubyte", limit, func);
        return images;
    }
    ...
    MNIST_dataset<Container, Image, Label> read_dataset_3d(std::size_t training_limit = 0, std::size_t test_limit = 0) {
        return read_dataset_3d<Container, Image, Label>("/Users/valyagorbunova/Library/Developer/Xcode/DerivedData/NeuralNetwork-gtsewaeridktwjbexvbrpkbvjuix/Build/Products/Debug/", training_limit, test_limit);;
    }
